...
{parsedItem.cloutesModel && (
  <>
    <View style={styles.infoRow}>
      ...
      <Text style={styles.info1}>{parsedItem.cloutesModel}</Text>
    </View>
    <View style={styles.separator} />
  </>
)}
...
{parsedItem.cloutesStatus && (
  <>
    <View style={styles.infoRow}>
      ...
      <Text style={styles.info1}>{parsedItem.cloutesStatus}</Text>
    </View>
    <View style={styles.separator} />
  </>
)}
...
{parsedItem.cloutesTexture && (
  <>
    <View style={styles.infoRow}>
      ...
      <Text style={styles.info1}>{parsedItem.cloutesTexture}</Text>
    </View>
    <View style={styles.separator} />
  </>
)}
